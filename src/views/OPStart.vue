  ...
  <el-container class="main-container">
    ...
    <el-header>
      ...
      >
        ...
        <el-submenu index="2">
          <template slot="title"
            ><span class="slot-font">使用指南</span></template
          >
          ...
          <el-submenu index="2-4">
            <template slot="title"
              ><span class="slot-font">常见问题</span></template
            >
        ...
        <el-menu-item index="4"
          ><a href="https://www.eating.work" target="_blank"
            >作者博客</a
          ></el-menu-item
        >
      </el-menu>
    ...
    <el-container>
      ...
      <el-container class="main-content">
        <el-main>
          <h2>
            <strong>ONEPIECE</strong><br />
            <span style="color: #409eff">主题 UI</span> <br />
            商城后台
          </h2>
          <!--function buttons  -->
          <div class="buttons">
          ...
          <img
            ...
            src="../assets/treasures.png"
            alt="treasures"
          />
        </el-main>
        <el-footer>
          <h3>
            &copy; A demo-website made by Alex Liu from Group 1 , guided by
            professor Xiong. 2022.7
          </h3>
        </el-footer>
      </el-container>
    </el-container>
...
export default {
  name: "OPHome",
  data() {
    return { opacity: 1, opacityBox: 1, activeIndex: "1", activeIndex2: "1" };
  },
  methods: {
  ...
  mounted() {
    setInterval(() => {
      ...
      if (this.opacityBox <= 0) this.opacityBox = 1;
    }, 16);
  },
